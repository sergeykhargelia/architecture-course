...
* **Mob** также наследуется от **Player** и соответствует мобу. Для него дополнительно хранится стратегия, в соответствии с которой он, зная текущее расположение персонажа, делает ход.
